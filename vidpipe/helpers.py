...
def draw_str(dst, x, y, s):
    cv2.putText(dst, s, (x+1, y+1), cv2.FONT_HERSHEY_PLAIN, 4.0, (0, 0, 0), thickness = 7, lineType=cv2.LINE_AA)
    cv2.putText(dst, s, (x, y), cv2.FONT_HERSHEY_PLAIN, 4.0, (255, 255, 255), thickness = 2, lineType=cv2.LINE_AA)
